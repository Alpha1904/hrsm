...
let UserController = class UserController {
    ...
    async updateEmployee(employeeId, updateEmployeeDetailsDto) {
        return await this.userService.updateEmployeeDetails(employeeId, updateEmployeeDetailsDto);
    }
    async updateHRAdminSites(hrAdminId, updateHRAdminSitesDto) {
...
__decorate([
    (0, common_1.Patch)(':employeeId/employee'),
    __param(0, (0, common_1.Param)('employeeId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_employee_details_dto_1.UpdateEmployeeDetailsDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateEmployee", null);
__decorate([
    (0, common_1.Patch)(':hrAdminId/sites'),
    __param(0, (0, common_1.Param)('hrAdminId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateHRAdminSites", null);
